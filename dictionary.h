...
class dict{
    public:
        std::string dictionary[41] = {KNIFE, SWORD, WBRANCH, AX, RIFLE, TRIDENT, WAND, EGG, COMMON_EGG, UNCOMMON_EGG, RARE_EGG, EPIC_EGG,
        ...
        MAGIC_MUSH, BOMB, HARM, MAGIC_HARM, SWIFT, MAGIC_SWIFT, BLOOD_DAGGER, HAMBURGER};
};
