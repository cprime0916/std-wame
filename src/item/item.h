...
namespace item{
    ...
    void sequence(std::vector<std::string>& items, std::vector<bool> is_heal, std::vector<bool> is_harm, std::vector<int> hp, std::vector<int> dmg, bool order, bool item_mode);
